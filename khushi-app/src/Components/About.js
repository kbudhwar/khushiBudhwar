    ...
    render(){
        return(
            ...
            <div className={this.state.scroll ? "background background-animation" : ""}>
                ...
                <div className={this.state.scroll ? "about-me" : "about-me-no"}>From interative websites to scalable applications, I love working on complex problems and finding creative solutions. I am passionate about machine learning, women in stem and all things space. Oh and I am a coffee fanatic!
